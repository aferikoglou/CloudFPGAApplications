...
(* X_CORE_INFO = "bd_1361,Vivado 2021.1" *)
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(aclk_freerun, aclk_ctrl, aclk_pcie, 
  aclk_kernel_00, aclk_kernel_00_cont, aclk_kernel_01, aclk_kernel_01_cont, aresetn_ctrl, 
  aresetn_pcie, aresetn_ctrl_slr0, aresetn_ctrl_slr1, aresetn_ctrl_slr2, aresetn_pcie_slr0, 
  ...
  aresetn_kernel_01_slr2, shutdown_clocks, s_axi_ctrl_mgmt_awaddr, 
...
/* synthesis syn_black_box black_box_pad_pin="aclk_freerun,aclk_ctrl,aclk_pcie,aclk_kernel_00,aclk_kernel_00_cont,aclk_kernel_01,aclk_kernel_01_cont,aresetn_ctrl,aresetn_pcie,aresetn_ctrl_slr0[0:0],aresetn_ctrl_slr1[0:0],aresetn_ctrl_slr2[0:0],aresetn_pcie_slr0[0:0],aresetn_pcie_slr1[0:0],aresetn_pcie_slr2[0:0],aresetn_kernel_00_slr0[0:0],aresetn_kernel_00_slr1[0:0],aresetn_kernel_00_slr2[0:0],aresetn_kernel_01_slr0[0:0],aresetn_kernel_01_slr1[0:0],aresetn_kernel_01_slr2[0:0],shutdown_clocks,s_axi_ctrl_mgmt_awaddr[23:0],s_axi_ctrl_mgmt_awprot[2:0],s_axi_ctrl_mgmt_awvalid[0:0],s_axi_ctrl_mgmt_awready[0:0],s_axi_ctrl_mgmt_wdata[31:0],s_axi_ctrl_mgmt_wstrb[3:0],s_axi_ctrl_mgmt_wvalid[0:0],s_axi_ctrl_mgmt_wready[0:0],s_axi_ctrl_mgmt_bresp[1:0],s_axi_ctrl_mgmt_bvalid[0:0],s_axi_ctrl_mgmt_bready[0:0],s_axi_ctrl_mgmt_araddr[23:0],s_axi_ctrl_mgmt_arprot[2:0],s_axi_ctrl_mgmt_arvalid[0:0],s_axi_ctrl_mgmt_arready[0:0],s_axi_ctrl_mgmt_rdata[31:0],s_axi_ctrl_mgmt_rresp[1:0],s_axi_ctrl_mgmt_rvalid[0:0],s_axi_ctrl_mgmt_rready[0:0]" */;
  input aclk_freerun;
  input aclk_ctrl;
  input aclk_pcie;
